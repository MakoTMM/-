...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.update_png = tk.PhotoImage(file='update.png')
        btn_edit_dialog = tk.Button(toolbar, bg='#d7d8e0', bd =0, image=self.update_png, command=self.open_update_dialog)
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        self.grab_set()# перехватываем все события происходящие в приложении
        self.focus_set()# захватываем фокус
...
# класс окна для обновления данных
class Update(Child):
    def __init__(self):
        super().__init__()
        self.init_update()
